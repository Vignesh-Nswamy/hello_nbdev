...
def main():
    crawl_data = pd.read_pickle(f'data/{args.domain}/crawl_data.pkl')
    vectorizer = pickle.load(open(f'data/{args.domain}/vectorizer.pk', 'rb'))
    q_vector = vectorizer.transform([args.query])
